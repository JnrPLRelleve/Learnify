...
// Only output JSON for AJAX requests, and exit after response
if ($_SERVER['REQUEST_METHOD'] === 'POST' && (isset($_FILES['profile_pic']) || isset($_POST['action'])) ) {
    ...
    // Action handling (username/password change)
...
<body>
    <div class="settings-container">
        <div class="settings-sidebar">
            <div class="profile_pic"><img src="<?php echo htmlspecialchars($profilePic); ?>" alt="student_picture"></div>
            ...
            <button class="back-btn" onclick="window.location.href='student_dashboard.php'">Back</button>
        </div>
        <div class="settings-content" id="settingsContent">
            CONTENT
        </div>
    </div>
    <script src="STU_settings.js"></script>
</body>
</html>
